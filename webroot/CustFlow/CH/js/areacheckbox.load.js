$(function () {	    
        ...
        $.get(url, {
           ...
           if (myobj == undefined) {
			...
			selectList += "<div  style='width:100px;height:40px;float:left;overflow:hidden;'>"+"<label style='float:left;'>区域:</label><input  id='checkall'   type='checkbox' style='margin-top:13px;margin-left:5px;float:left;'/><label style='margin-left:2px;'>全部</lable></div>";
