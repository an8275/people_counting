			...
			.get(
					...
					function(data, textStatus) {
						...
						for ( var i in myobj["deviceList"]) {
							...
							rowData[2] = "<a title='Click to delete' onclick='DeleteOneVirtual(this);'><img src='../images/cross.png' alt='点击删除' /> </a>";
...
function DeleteOneVirtual(obj) {
	if (!confirm("Are you sure to delete this message?Retrieve impossible after deletion！")) {
		return;
	}
