			...
			.get(
					...
					function (data, textStatus) {
					    ...
					    if (textStatus != "success") {
					        ...
					        $("#inout_Error")
									.append(
											"<div id='inout_Errordiv'>Error!!</br>Please<a href='javascript:createInOut();'class='pagecolor'>refresh the page</a></div>");
					        return;
					    }
					    if (data === "ERROR") {
					        $("#inout_Shadow").hide();
					        ...
					        $("#inout_Error")
									.append(
											"<div id='inout_Errordiv'>Background support run error!!</br>Please<a href='javascript:createInOut();'class='pagecolor'>refresh the page</a></div>");
					        return;
					    }
					    try {
					        var myobj = eval('(' + data + ')');
					        ...
					        $("#inout_Error")
									.append(
											"<div id='inout_Errordiv'>Data conversion failed, wrong page format!!</br>Please<a href='javascript:createInOut();'class='pagecolor'>refresh the page</a></div>");
					    ...
					    if (myobj == undefined) {
					        ...
					        $("#inout_Error")
									.append(
											"<div id='inout_Errordiv'>Data accessing failed!!</br>Please<a href='javascript:createInOut();'class='pagecolor'>refresh the page</a></div>");
